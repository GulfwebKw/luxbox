        ...
        <?php if(count($resources)): ?>
            ...
            <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="search-body">
                    ...
                    <td>
                        <?php echo $resource->description_en; ?>

                    </td>
                    <td>
                        <?php echo $resource->description_ar; ?>

                    </td>
                    <td>
                        <?php echo $resource->time_mon_fir; ?>

                    </td>
                    <td>
                        <?php echo $resource->time_sat; ?>

                    </td>
                    <td>
                        <?php echo $resource->time_sun; ?>
...
<?php echo $__env->make('gwc.template.indexTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/gwc/contact-descrpition/index.blade.php ENDPATH**/ ?>