...
<div class="cases-standard">
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-12"><h5 class="heading-title"><?php echo e(__('website.member.RECENTPACKAGES')); ?></h5> </div>
<?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="case-item col-sm-12 col-md-12 col-lg-4 work-item">
				<div class="case-item-warp">
					<div class="case-img">
						<div class="work-item-container"><div class="work-img"><img src="<?php echo e(asset('/uploads/packages/'. $package->image)); ?>" alt="post" />
						<div class="work-hover"><div class="work-action"><div class="work-zoom"><a class="img-gallery-item" href="<?php echo e(asset('/uploads/packages/'. $package->image)); ?>" title="Post"></a></div></div></div></div></div>
					</div>
					<div class="case-content">
						<div class="case-desc text--center">
							<p><strong class="body_color"><?php echo e($package->package_type); ?></strong><br/>
								Package #: <?php echo e($package->order); ?><br/>
								Quantity: <?php echo e($package->boxes_count); ?><br/>
								Original track id: <strong class="gray_color"><?php echo e($package->original_track_id); ?></strong> <a href="#" title="Copy Original Track ID"> &nbsp;<i class="far fa-copy"></i></a><br/>
								</p>
						</div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/member/my-account.blade.php ENDPATH**/ ?>