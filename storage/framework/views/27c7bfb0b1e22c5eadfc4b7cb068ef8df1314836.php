...
<div class="wrapper clearfix" id="wrapperParallax1">
            ...
            <div class="ml-5">
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="<?php echo e(url('/services')); ?>"><span><?php echo e(__('website.menu.services')); ?></span></a></li>
    ...
    <section class="page-title bg-overlay bg-overlay-dark bg-parallax" id="page-title">
        ...
        <h1><?php echo e($header['title_services_'.$lang]); ?></h1>
        </div>
        <div class="clearfix"></div>
        <ol class="breadcrumb justify-content-lg-start">
        <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>"><?php echo e(__('website.menu.Home')); ?></a></li>
        <li class="breadcrumb-item active" aria-current="page"><?php echo e($header['title_services_'.$lang]); ?></li>
        </ol>
        </div>
        </div>
        </div>
        ...
        <h2 class="heading-title"><?php echo e(__('website.content.Our_Services')); ?></h2>
        </div>
        </div>
        ...
        <div class="service-img"><a href="<?php echo e(route('service' , [$service->id])); ?>"></a><img src="<?php echo e(asset('uploads/services/'.$service->image)); ?>" alt="service img" /></div>
        
        <div class="service-content">
        <div class="service-title <?php if($lang == "ar" ): ?> text-right <?php endif; ?>" >
        <h4><a href="<?php echo e(route('service' , [$service->id])); ?>"><?php echo e($service['title_'.$lang]); ?></a></h4>
        </div>
        <div class="service-desc">
        <p><?php echo \Illuminate\Support\Str::limit($service['description_'.$lang], 50); ?></p>
        </div>
        <div class="service-more"><a class="btn" href="<?php echo e(route('service' , [$service->id])); ?>"> <i class="icon-arrow-right"></i><span><?php echo e(__('website.content.Read_more')); ?></span></a></div>
        </div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/front/pages/services.blade.php ENDPATH**/ ?>