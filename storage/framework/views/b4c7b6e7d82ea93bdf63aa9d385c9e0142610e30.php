                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item">
                                            ...
                                            ?>
                                            <a href="<?php echo e(url('/gwc/countries/' . $resource->id . '/cities')); ?>" class="kt-nav__link">
                                                <i class="kt-nav__link-icon flaticon2-contract"></i>
                                                <span class="kt-nav__link-text">
                                                    <?php echo e(__('adminMessage.cities') . ' (' . $count . ')'); ?>
...
<?php echo $__env->make('gwc.template.indexTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/gwc/countries/index.blade.php ENDPATH**/ ?>