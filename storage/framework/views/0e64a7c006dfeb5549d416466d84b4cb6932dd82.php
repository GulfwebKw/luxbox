...
<?php $__env->startSection('indexContent'); ?>
    <table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tr>
            <th width="10">#</th>
            <th><?php echo e(__('adminMessage.firstname')); ?></th>
            <th><?php echo e(__('adminMessage.lastname')); ?></th>
            <th><?php echo e(__('adminMessage.mobile')); ?></th>
                        ...
                        <span class="kt-switch">
                            <label>
                                <input type="checkbox" id="<?php echo e($data['path']); ?>" class="change_status"
                                       value="<?php echo e($resource->id); ?>" <?php echo e($resource->is_active?'checked':''); ?>>
                                <span></span>
                            </label>
                        </span>
                    </td>
...
<?php echo $__env->make('gwc.template.indexTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/gwc/users/index.blade.php ENDPATH**/ ?>