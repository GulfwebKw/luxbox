    ...
    <form name="tFrm" id="form_validation" method="post" class="kt-form" enctype="multipart/form-data" action="<?php echo e(route($data['storeRoute'])); ?>">
        ...
        <div class="kt-portlet__body">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <?php $__env->startComponent('gwc.components.createTinyMce', [
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <?php $__env->startComponent('gwc.components.createDisplayOrder', [
                                    'lastOrder' => $lastOrder
                                ]); ?> <?php echo $__env->renderComponent(); ?>
                            </div>
                        </div>
...
<?php echo $__env->make('gwc.template.createTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/gwc/blogs/create.blade.php ENDPATH**/ ?>