                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="title text-lg-left">
                        <div class="title-heading">
                            <h1><?php echo e(__('website.member.Forgot_Password')); ?></h1>
                        </div>
                        <div class="clearfix"></div>
                        <ol class="breadcrumb justify-content-lg-start">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>"><?php echo e(__('website.menu.Home')); ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('website.member.Forgot_Password')); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 offset-lg-4">
                    <div class="accordion accordion-4">
                       ...
                       <?php echo csrf_field(); ?>
                        <div class="col-12 col-lg-12"><label><?php echo e(__('website.member.Email_Address')); ?></label><input class="form-control" type="email" name="email" placeholder="<?php echo e(__('website.member.Email_Address')); ?>" required /></div>
                        <div>&nbsp;</div>
                        <div class="col-12 col-lg-12"><input class="btn btn--primary offset-lg-2" type="submit" value="<?php echo e(__('website.member.Reset_Password')); ?>" /></div>
                        <div>&nbsp;</div>
                        </form>
                        <div class="col-12 col-lg-12"><?php echo e(__('website.member.have_an_Account')); ?> <a href="<?php echo e(url('/login')); ?>"><?php echo e(__('website.member.Login_Here')); ?></a></div>
                    </div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/member/forgot-password.blade.php ENDPATH**/ ?>