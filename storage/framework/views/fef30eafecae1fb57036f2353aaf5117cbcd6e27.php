...
<div class="wrapper clearfix" id="wrapperParallax1">
            ...
            <div class="ml-5">
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="<?php echo e(url('/works')); ?>"><span><?php echo e(__('website.menu.How_it_Works')); ?></span></a></li>
    ...
    <section class="page-title bg-overlay bg-overlay-dark bg-parallax" id="page-title">
        <div class="bg-section"><img src="<?php echo e(asset('uploads/headers/'.$header->image_header_how_it_work)); ?>" alt="Background" /></div>
        <div class="container">
        <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-6">
        <div class="title text-lg-left">
        <div class="title-heading">
        <h1><?php echo e(__('website.menu.How_it_Works')); ?></h1>
        </div>
        <div class="clearfix"></div>
        <ol class="breadcrumb justify-content-lg-start">
        <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>"><?php echo e(__('website.menu.Home')); ?></a></li>
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('website.menu.How_it_Works')); ?></li>
        </ol>
        </div>
        </div>
        </div>
        ...
        <div class="bg-section"><img class="img-fluid" src="<?php echo e(asset('uploads/how-it-work/'.$work->image_top)); ?>" alt="about Image" /></div>
        </div>
        ...
        <br/>
        <p><?php echo $work['description_'.$lang.'_1']; ?></p>
        </div>
        </div>
        ...
        <br/>
            <p><?php echo $work['description_'.$lang.'_2']; ?></p>
        </div>
        </div>
        ...
        <div class="bg-section"><img src="<?php echo e(asset('uploads/how-it-work/'.$work->image_middle)); ?>" alt="image" /></div>
        </div>
        </div>
        </div>
        </div>
        ...
        <br/>
            <p><?php echo $work['description_'.$lang.'_3']; ?></p>
        </div>
        ...
        <br/>
            <p><?php echo $work['description_'.$lang.'_4']; ?></p>
        </div>
        </div>
        
        <div class="col-12 col-lg-6">
        <div class="video video-1" id="video1">
        <div class="bg-section"><img src="<?php echo e(asset('uploads/how-it-work/'.$work->image_buttom)); ?>" alt="background" /></div>
        </div>
        </div>
        </div>
        ...
        <br/>
            <p><?php echo $work['description_'.$lang.'_5']; ?></p>
        </div>
        </div>
        </div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/front/pages/how-to-work.blade.php ENDPATH**/ ?>