<?php $__env->startSection('indexContent'); ?>
    <table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tr>
            ...
            <th><?php echo e(__('adminMessage.shipping_cost')); ?></th>
            <th><?php echo e(__('adminMessage.payment_method')); ?></th>
            <th><?php echo e(__('adminMessage.status')); ?></th>
        ...
        <?php if(count($resources)): ?>
            ...
            <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="search-body">
                    ...
                    <td>
                        <?php echo '#'.$resource['package']->order; ?>

                    </td>
                    <td>
                        <?php echo $resource->shipping_cost; ?>

                    </td>
                    <td>
                        <?php echo $resource->payment_method; ?>
...
<?php echo $__env->make('gwc.template.indexTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqqvtwm/private/resources/views/gwc/package-invoice/index.blade.php ENDPATH**/ ?>