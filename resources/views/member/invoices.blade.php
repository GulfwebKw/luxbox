                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="title text-lg-left">
                            <div class="title-heading">
                                <h1>{{ __('website.member.Invoices') }}</h1>
                            </div>
                            ...
                            <ol class="breadcrumb justify-content-lg-start">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ __('website.member.Invoices') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="cases-standard">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-12"><h5 class="heading-title">{{ __('website.member.Invoices') }}</h5>
                        </div>

                        <table class="table table-striped">
                            <tr>
                                <th>{{ __('webMessage.date') }}</th>
                                <th>{{ __('website.shipping.ORDER') }} #</th>
                                <th>{{ __('website.shipping.Payment_Method') }}</th>
                                <th>{{ __('website.shipping.Shipping_Cost') }}</th>
                                <th>{{ __('website.shipping.Status') }}</th>
                                <th>&nbsp;</th>
                            </tr>
                                    ...
                                    <td>
                                        @if($invoice->status =='paid')
                                            <a href="{{route('invoices.show', $invoice->id)}}">
                                                <button type="button" class="btn_blue">{{ __('website.shipping.Show_Invoice') }}</button>
                                            </a>
                                        @endif
