...
<div class="bg-section"><img src="{{asset('uploads/headers/'.$header->image_header_login)}}" alt="Background" /></div>
<div class="container">
<div class="row">
<div class="col-sm-12 col-md-12 col-lg-6">
<div class="title text-lg-left" style="padding:150px 0 75px 0;">
<div class="title-heading">
<h1>{{$header['title_login_'.$lang]}}</h1>
</div>
<div class="clearfix"></div>
<ol class="breadcrumb justify-content-lg-start">
<li class="breadcrumb-item"><a href="{{ url('/') }}">{{ __('website.menu.Home') }}</a></li>
<li class="breadcrumb-item active" aria-current="page">{{$header['title_login_'.$lang]}}</li>
</ol>
</div>
</div>
</div>
...
<div class="accordion accordion-4">
	...
	<div>&nbsp;</div>
	<div class="col-12 col-lg-12"><input class="btn btn--primary offset-lg-2" type="submit" value="{{ __('website.member.Login') }}"/></div>
	</form>
	<div>&nbsp;</div>
	<div class="col-12 col-lg-12">{{ __('website.member.Dont_have_Account') }} <a href="{{url('register')}}">{{ __('website.member.Register_Now') }}</a></div>
</div>
</div>
</div>
</div>
