...
@endif
					...
					<div class="col-sm-12 col-md-12 col-lg-3">
						<ul class="my_list">
							...
							<li>Order Created: <strong class="body_color">{{$package->created_at->format('y-m-d')}}</strong></li>
							<li>Order Total: <strong class="body_color">{{'$'.$package['invoice']->shipping_cost}}</strong></li>
							<li>Number of Packages: <strong class="body_color">{{$package->boxes_count}}</strong></li>
