                ...
                <div class="col-12 col-lg-4 offset-lg-4">
                    <div class="accordion accordion-4">
                        <form action="{{ route('reset.password.post') }}" method="post">
                            ...
                            <div>&nbsp;</div>
                            <div class="col-12 col-lg-12"><label>{{ __('website.member.New_Password') }}</label><input class="form-control" type="password" name="password" placeholder="{{ __('website.member.New_Password') }}" required /></div>
                            <div>&nbsp;</div>
                            <div class="col-12 col-lg-12"><label>{{ __('website.member.Confirm_New_password') }}</label><input class="form-control" type="password" name="password_confirmation" placeholder="{{ __('website.member.Confirm_New_password') }}" required /></div>
                            <div>&nbsp;</div>
