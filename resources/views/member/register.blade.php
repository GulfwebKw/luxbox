                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <form action="{{url('register/store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-3">
                                    <label>{{ __('webMessage.confirm') }} {{ __('website.member.Email_Address') }} <span>*</span></label>
                                    <input class="form-control" type="text" name="email_confirmation" value="{{ old('email_confirmation') }}"
                                           placeholder="{{ __('webMessage.confirm') }}  {{ __('website.member.Email_Address') }}" required/>
                                </div>
                                <div class="col-12 col-lg-3">
                                ...
                                <div class="col-12 col-lg-3">
                                    <label>{{ __('webMessage.confirm') }} {{ __('website.member.Password') }} <span>*</span></label>
                                    <input class="form-control" type="password" name="password_confirmation"
                                           placeholder="{{ __('webMessage.confirm') }} {{ __('website.member.Password') }}" required/>
                                </div>
