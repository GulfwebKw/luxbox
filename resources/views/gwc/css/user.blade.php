...
<link href="{!! asset('admin_assets/assets/css/pages/wizard/wizard-4.css') !!}" rel="stylesheet" type="text/css"/>

<!--end::Global Theme Styles -->
<!--begin::Layout Skins(used by all pages) -->
<link href="{{asset('/admin_assets/assets/css/fonts/fontAwesome/css/fontawesome.min.css')}}" rel="stylesheet" type="text/css"/>
