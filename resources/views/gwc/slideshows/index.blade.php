...
@section('indexContent')
    <table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tr>
            ...
            <th>{{__('adminMessage.categorydescription_en')}}</th>
            <th>{{__('adminMessage.categorydescription_ar')}}</th>
        ...
        @if(count($resources))
            ...
            @foreach($resources as $resource)
                <tr class="search-body">
                    ...
                    <td>
                        {{ Illuminate\Support\Str::limit(strip_tags($resource->description_en)) }}
                    </td>
                    <td>
                        {{ Illuminate\Support\Str::limit(strip_tags($resource->description_ar)) }}
                    </td>
                    <td>
