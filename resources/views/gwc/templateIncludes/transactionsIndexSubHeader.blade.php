    ...
    <div class="kt-container kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            ...
            @if(Cookie::get('payment_filter_dates'))
                <button type="button" class="btn btn-danger btn-bold resetTransactionDateRange mx-2">{{__('adminMessage.reset')}}</button>
            @endif
            ...
            <div class="kt-subheader__wrapper mx-2">
                <div class="kt-input-icon kt-input-icon--right kt-subheader__search" style="width: fit-content">
                    <input type="text" class="form-control"  name="kt_daterangepicker_range" id="kt_daterangepicker_range" placeholder="Select Date Range"
                           value="@if(Cookie::get('payment_filter_dates')){{Cookie::get('payment_filter_dates')}}@endif">
                    <button id="filterTransactionsByDate" style="border:0;" class="kt-input-icon__icon kt-input-icon__icon--right">
                        <span>
            ...
            <div class="btn-group mx-2">
                <button type="button" class="btn btn-primary btn-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    @if(Cookie::get('payment_filter_status')){{strtoupper(Cookie::get('payment_filter_status'))}}@else{{strtoupper(__('adminMessage.all'))}}@endif
                </button>
