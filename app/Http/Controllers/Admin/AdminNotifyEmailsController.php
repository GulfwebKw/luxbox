...
class AdminNotifyEmailsController extends Controller
{
    public $settings;
    public $model;
    public $path;
    ...
    public function __construct()
    {
        ...
        $this->model = '\App\NotifyEmail';
        $this->title = 'Notify Emails';
        $this->path = 'notifyemails';
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:gwc_notify_emails,display_order',
            'name' => 'required|string',
            'email' => 'required|email',
        ]);

        $resource = new NotifyEmail();
    ...
    public function update(Request $request, $id)
    {
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:gwc_notify_emails,display_order,' . $id,
            'name' => 'required|string',
