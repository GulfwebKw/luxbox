...
//        $resources = $this->model::orderBy('display_order', $this->settings->default_sort)->paginate($this->settings->item_per_page_back);
        ...
        return redirect('/gwc/abouts/'.$resources->id.'/edit');
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:abouts,display_order',
        ...
        $resource->counter = $request->input('counter');
    ...
    public function update(Request $request, $id)
    {
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:abouts,display_order,' . $id,
            'image' => 'mimes:jpeg,png,jpg,gif,svg',
            'title_en' => 'required|string',
            'title_ar' => 'required|string',
            'description_en' => 'required',
